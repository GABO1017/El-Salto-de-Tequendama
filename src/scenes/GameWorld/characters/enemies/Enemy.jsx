...
const Enemy = forwardRef(
  (
    ...
    useEffect(() => {
      const allActions = Object.values(actions).filter(Boolean); // Filtra valores undefined
      ...
      if (isPaused) {
        allActions.forEach((action) => {
          try {
            ...
            console.warn("❌ No se pudo pausar acción:", e);
          }
        });
      } else {
        allActions.forEach((action) => {
          try {
            ...
            console.warn("❌ No se pudo reanudar acción:", e);
          }
        });
      }
    }, [isPaused, actions]);
